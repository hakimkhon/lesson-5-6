...
class DetailWoman(RetrieveUpdateAPIView, RetrieveDestroyAPIView):
...
class WomanAPIView(APIView):
    ...
    def get(self, request):
        ...
        return Response({'posts': WomanSerializers(lst, many=True).data}) #many bu malumot bo'lsa uni to'yxat shaklida chiqarish uchun
